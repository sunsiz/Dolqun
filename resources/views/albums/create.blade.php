                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ route('album.store') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('name_ug') ? 'has-error' : '' }}">
                                        <input type="text" class="form-control"  placeholder="ئۇيغۇرچە نامى (چوقۇم يازىسىز)" name="name_ug" value="{{ old('name_ug') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('name_zh') ? 'has-error' : '' }}">
                                        <input type="text" class="form-control"  placeholder="خەنزۇچە نامى (چوقۇم يازىسىز)" name="name_zh" value="{{ old('name_zh') }}">
                            ...
                            <div class="form-group {{ $errors->has('bio') ? 'has-error' : '' }}">
                                <textarea id="container" name="bio" class="form-control" placeholder="بوغچا ئىزاھاتى (يازمىسىڭىزمۇ بولىدۇ)"> {{ old('bio') }}</textarea>
                            </div>
